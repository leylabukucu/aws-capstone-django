...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/lydia/capstone/username')
    password_param = ssm.get_parameter(Name="/lydia/capstone/password", WithDecryption=True)
...
AWS_STORAGE_BUCKET_NAME = 'second-capstone' # please enter your s3 bucket name
